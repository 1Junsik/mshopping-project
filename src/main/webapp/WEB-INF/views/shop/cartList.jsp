...
/*       a { color:#05f; text-decoration:none; }
      ...
      footer#footer { display:flex; flex-wrap:wrap; margin-right:-15px; margin-left:-15px; background:#F3F6FA; padding-top: 70px; padding-bottom: 0; }
      ...
      footer#footer { margin-top:100px; border-radius:0px 0px 0 0; text-align: center; }
      footer#footer div#footer_box { padding:20px 20px; }
   ...
   <style>
      ...
      */
      ...
      .listResult .sum ul { display: block; list-style-type: disc; mar }
      .listResult .sum ul li {font-size: 16px;   color: #1c1c1c;   font-weight: 700;   list-style: none; overflow: hidden;    border-bottom: 1px solid #ebebeb;    padding-bottom: 13px;    margin-bottom: 18px;}
      .listResult .sum ul li span{font-size: 18px; color: #dd2222; float: right;}
      
      .listResult .orderOpne { float:right; width:50%; text-align:right; margin-bottom: 50px; }
...
<!--             <li><a href="#">카테고리</a>
   ...
   <section id="container">
      <div id="container_box">
         ...
         <div class="orderInfo">
            <form action="cartList" method="post" autocomplete="off">
